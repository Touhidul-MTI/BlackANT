...
<html>
						...
						<link rel="stylesheet" href="../css/font-awesome.min.css">
							<link rel="stylesheet" href="../css/style_default.css">
								<link rel="stylesheet" href="../css/style_single_navbar.css">
									...
									<!--<script src="../js/employee_updater_blackant.js"></script>
									-->
	</head>
	...
	<body class="custom-body">
		...
		<div class="container">
			...
			<form id="formId" class="form-horizontal" action="../employeeupdater" method="post"
				name="employeeForm">

				<h3 class="text-center">Employee Update Form</h3>
